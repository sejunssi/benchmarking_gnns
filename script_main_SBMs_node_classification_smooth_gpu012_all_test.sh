...
do
    ...
    tmux send-keys "
    python main_SBMs_node_classification_smooth.py --dataset SBM_CLUSTER --lb_delta=0.05 --ub_delta=0.15 --how_residual=rk2  --gpu_id 1 --seed 41 --config configs/SBMs_node_clustering_GIN_CLUSTER_SMOOTH.json

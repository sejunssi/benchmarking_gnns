...
do
    ...
    tmux send-keys "
    python main_SBMs_node_classification_smooth.py --middle_dim=32 --dataset SBM_CLUSTER --delta=0.2 --how_residual=rk2  --gpu_id 1 --seed 41 --config configs/SBMs_node_clustering_GAT_CLUSTER_SMOOTH.json

...
do
  ...
  tmux send-keys "
  python $code --dataset $dataset --residual=False --gpu_id 0 --train_soft_target True --seed $seed0 --config 'configs/SBMs_node_clustering_MLP_CLUSTER_a${a}.json' &
  python $code --dataset $dataset --residual=False --gpu_id 1 --train_soft_target True --seed $seed1 --config 'configs/SBMs_node_clustering_MLP_CLUSTER_a${a}.json' &
  python $code --dataset $dataset --residual=False --gpu_id 2 --train_soft_target True --seed $seed2 --config 'configs/SBMs_node_clustering_MLP_CLUSTER_a${a}.json' &

  wait" C-m
  tmux send-keys "
  python $code --dataset $dataset --residual=False --gpu_id 0 --train_soft_target True --seed $seed0 --config 'configs/SBMs_node_clustering_MLP_GATED_CLUSTER_a${a}.json' &
  python $code --dataset $dataset --residual=False --gpu_id 1 --train_soft_target True --seed $seed1 --config 'configs/SBMs_node_clustering_MLP_GATED_CLUSTER_a${a}.json' &
  python $code --dataset $dataset --residual=False --gpu_id 2 --train_soft_target True --seed $seed2 --config 'configs/SBMs_node_clustering_MLP_GATED_CLUSTER_a${a}.json' &
...
do
  ...
  tmux send-keys "
  python $code --dataset $dataset --residual=False --gpu_id 0 --train_soft_target True --seed $seed0 --config 'configs/SBMs_node_clustering_MLP_PATTERN_a${a}.json' &
  python $code --dataset $dataset --residual=False --gpu_id 1 --train_soft_target True --seed $seed1 --config 'configs/SBMs_node_clustering_MLP_PATTERN_a${a}.json' &
  python $code --dataset $dataset --residual=False --gpu_id 2 --train_soft_target True --seed $seed2 --config 'configs/SBMs_node_clustering_MLP_PATTERN_a${a}.json' &

  wait" C-m
  tmux send-keys "
  python $code --dataset $dataset --residual=False --gpu_id 0 --train_soft_target True --seed $seed0 --config 'configs/SBMs_node_clustering_MLP_GATED_PATTERN_a${a}.json' &
  python $code --dataset $dataset --residual=False --gpu_id 1 --train_soft_target True --seed $seed1 --config 'configs/SBMs_node_clustering_MLP_GATED_PATTERN_a${a}.json' &
  python $code --dataset $dataset --residual=False --gpu_id 2 --train_soft_target True --seed $seed2 --config 'configs/SBMs_node_clustering_MLP_GATED_PATTERN_a${a}.json' &
...
do
  ...
  tmux send-keys "
  python $code --dataset $dataset --residual=False --gpu_id 0 --train_soft_target True --seed $seed0 --config 'configs/SBMs_node_clustering_MLP_CLUSTER_w${w}.json' &
  python $code --dataset $dataset --residual=False --gpu_id 1 --train_soft_target True --seed $seed1 --config 'configs/SBMs_node_clustering_MLP_CLUSTER_w${w}.json' &
  python $code --dataset $dataset --residual=False --gpu_id 2 --train_soft_target True --seed $seed2 --config 'configs/SBMs_node_clustering_MLP_CLUSTER_w${W}.json' &

  wait" C-m
  tmux send-keys "
  python $code --dataset $dataset --residual=False --gpu_id 0 --train_soft_target True --seed $seed0 --config 'configs/SBMs_node_clustering_MLP_GATED_CLUSTER_w${w}.json' &
  python $code --dataset $dataset --residual=False --gpu_id 1 --train_soft_target True --seed $seed1 --config 'configs/SBMs_node_clustering_MLP_GATED_CLUSTER_w${w}.json' &
  python $code --dataset $dataset --residual=False --gpu_id 2 --train_soft_target True --seed $seed2 --config 'configs/SBMs_node_clustering_MLP_GATED_CLUSTER_w${w}.json' &

...
do
  ...
  tmux send-keys "
  python $code --dataset $dataset --residual=False --gpu_id 3 --onehot True --seed $seed3 --config 'configs/SBMs_node_clustering_MLP_CLUSTER_a${a}.json' &
  wait" C-m
  tmux send-keys "
  python $code --dataset $dataset --residual=False --gpu_id 3 --onehot True --seed $seed3 --config 'configs/SBMs_node_clustering_MLP_GATED_CLUSTER_a${a}.json' &
  wait" C-m
...
do
  ...
  tmux send-keys "
  python $code --dataset $dataset --residual=False --gpu_id 3 --onehot True --seed $seed3 --config 'configs/SBMs_node_clustering_MLP_PATTERN_a${a}.json' &
  wait" C-m
  tmux send-keys "
  python $code --dataset $dataset --residual=False --gpu_id 3 --onehot True --seed $seed3 --config 'configs/SBMs_node_clustering_MLP_GATED_PATTERN_a${a}.json' &
  wait" C-m
...
do
  ...
  tmux send-keys "
  python $code --dataset $dataset --residual=False --gpu_id 3 --onehot True --seed $seed3 --config 'configs/SBMs_node_clustering_MLP_CLUSTER_w${w}.json' &
  wait" C-m
  tmux send-keys "
  python $code --dataset $dataset --residual=False --gpu_id 3 --onehot True --seed $seed3 --config 'configs/SBMs_node_clustering_MLP_GATED_CLUSTER_w${w}.json' &
  wait" C-m

...
from nets.wiki_regression.load_net import gnn_model # import GNNs
from data.data import LoadData # import dataset
from train.train_wiki_node_regression import train_epoch, evaluate_network # import train functions
        ...
        with tqdm(range(params['epochs'])) as t:
            ...
            for epoch in t:
                ...
                if time.time()-start0 > params['max_time']*3600:
                    ...
                    break
            csv_file = open(f'./{params["seed"]}_{str(net_params["residual"])}_{DATASET_NAME}_{MODEL_NAME}_epoch_files.csv', 'w')
...
def main():
    ...
    parser.add_argument('--is_multifeature', help="Please give a value for is_multifeature")
...
#    pdb.set_trace()
    ...
    if args.is_multifeature is not None:
        net_params['is_multifeature'] = True if args.is_multifeature=='True' else False
    else:
        net_params['is_multifeature'] = True
